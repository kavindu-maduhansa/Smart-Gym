        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="backdrop-blur-md bg-gradient-to-r from-orange/20 to-orange/10 border border-orange/30 rounded-2xl shadow-2xl p-6 sm:p-8 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-lg p-4 hover:bg-white/15 transition-all">
                <p className="text-gray-300 text-xs sm:text-sm font-semibold mb-2">
                  Membership Type
                </p>
              ...
              <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-lg p-4 hover:bg-white/15 transition-all">
                <p className="text-gray-300 text-xs sm:text-sm font-semibold mb-2">Status</p>
                <p className={`text-lg sm:text-xl font-bold ${isExpired ? "text-red-400" : "text-orange"}`}>
                  {membershipStatus}
                </p>
              </div>
            </div>
          ...
          {isExpired && (
            <div className="backdrop-blur-md bg-red-600/20 border border-red-500/50 text-white p-6 sm:p-8 rounded-2xl mb-8">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <button onClick={() => navigate("/membership")} className="w-full bg-orange hover:bg-orange/90 text-white font-bold px-6 py-2 rounded-lg transition-all text-sm sm:text-base">
                    REQUEST RENEWAL NOW
                  </button>
                </div>
              </div>
            ...
            {[
              ...
              <div key={idx} onClick={() => navigate(item.link)} className="group relative backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-5 sm:p-6 hover:bg-white/15 hover:border-orange/50 transition-all transform hover:scale-105 hover:shadow-2xl hover:shadow-orange/20 cursor-pointer">
                <div className="relative z-10">
                  <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-orange/20 rounded-xl mb-4 group-hover:bg-orange/30 transition-colors">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-orange" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
          ...
          {/* Quick Stats */}
          <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-lg p-6 sm:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">Account Information</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-lg p-4 hover:bg-white/10 transition-all">
                <p className="text-gray-400 text-xs sm:text-sm mb-2">Account Type</p>
                <p className="text-white text-lg sm:text-xl font-bold capitalize">{user?.role}</p>
              </div>
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-lg p-4 hover:bg-white/10 transition-all">
                <p className="text-gray-400 text-xs sm:text-sm mb-2">Email</p>
                <p className="text-white text-lg sm:text-xl font-bold truncate">{user?.email}</p>
              </div>
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-lg p-4 hover:bg-white/10 transition-all">
