  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 pt-32 pb-20">
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl sm:text-6xl font-bold mb-6 leading-tight">
              <span className="text-white">Smart Gym Management System</span>
            </h1>
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-8 sm:p-10 max-w-5xl mx-auto">
          ...
          <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-8 sm:p-10 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {highlights.map((item) => (
                <div
                  key={item}
                  className="border border-white/15 rounded-xl px-5 py-4 bg-black/20"
                >
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {milestones.map((milestone) => (
              ...
              >
                <p className="text-orange font-bold text-lg mb-2">{milestone.year}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {teamRoles.map((item) => (
              <div
                ...
                className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-6 sm:p-8"
              >
                <h3 className="text-2xl font-bold text-orange mb-3">{item.role}</h3>
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <h3 className="text-3xl sm:text-4xl font-bold text-orange mb-2">Easy</h3>
              <p className="text-gray-300">Simple workflows for daily operations</p>
            </div>
            <div className="text-center">
              <h3 className="text-3xl sm:text-4xl font-bold text-orange mb-2">Fast</h3>
              <p className="text-gray-300">Quick access to key gym tasks</p>
            </div>
            <div className="text-center">
              <h3 className="text-3xl sm:text-4xl font-bold text-orange mb-2">Reliable</h3>
              <p className="text-gray-300">Consistent support for members and staff</p>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="backdrop-blur-md bg-gradient-to-r from-orange/10 to-orange/5 border border-orange/30 rounded-3xl p-8 sm:p-12 text-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
              <button
                ...
                className="px-8 py-3 bg-orange text-white font-bold rounded-lg hover:bg-orange/90 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-orange/50"
              >
                Create Account
              </button>
              <button
                type="button"
                onClick={() => navigate("/")}
                className="px-8 py-3 border-2 border-orange text-orange font-bold rounded-lg hover:bg-orange/10 transition-all duration-300 transform hover:scale-105"
              >
                Back to Home
              </button>
            </div>
