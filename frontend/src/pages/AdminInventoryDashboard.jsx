            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {cards.map((card, i) => (
                <div
                  ...
                  className="group relative backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-6 hover:bg-white/15 hover:border-orange/50 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-orange/20 cursor-pointer"
                >
                  <div className="relative z-10">
                    ...
                    <button className="w-full bg-orange hover:bg-orange/90 text-white font-bold px-4 py-2 rounded-lg transition-all duration-300 text-xs sm:text-sm">
                      {card.btn}
                    </button>
                  </div>
                </div>
            ...
            <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-orange/10 to-orange/5 border border-orange/20 rounded-xl hover:border-orange/50 transition">
                  ...
                  <span className="text-2xl font-bold text-orange">150</span>
                </div>
