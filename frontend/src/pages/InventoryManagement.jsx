        ...
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="backdrop-blur-md bg-gradient-to-r from-blue-600/20 to-blue-600/10 border border-blue-600/30 rounded-2xl shadow-2xl p-6 sm:p-8 mb-8 sm:mb-12">
            <div className="flex items-center gap-3 sm:gap-4 mb-2 sm:mb-4">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-slate-900">Inventory Management</h1>
            </div>
          ...
          <div className="backdrop-blur-md bg-slate-100 border border-slate-300 rounded-xl p-6 sm:p-8">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="backdrop-blur-md bg-white border border-slate-200 rounded-lg p-6 text-center shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Equipment Tracking</h3>
                <p className="text-slate-600 text-xs sm:text-sm">Monitor gym equipment inventory</p>
              </div>
              <div className="backdrop-blur-md bg-white border border-slate-200 rounded-lg p-6 text-center shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Stock Alerts</h3>
                <p className="text-slate-600 text-xs sm:text-sm">Get notified when stock is low</p>
              </div>
              <div className="backdrop-blur-md bg-white border border-slate-200 rounded-lg p-6 text-center shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Maintenance Log</h3>
                <p className="text-slate-600 text-xs sm:text-sm">Track equipment maintenance</p>
              </div>
            </div>
          </div>
        </div>
